    ...
    <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-[90%] 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        ...
        <Link to="/" onClick={() => setOpen(false)} className="flex items-center gap-3 group">
          <img src="/images/logo.png" alt="krishiX" className="w-9 h-9 object-contain" />
          <div>
            <p className="font-extrabold text-lg leading-none tracking-tight text-gray-00 dark:text-white font-display">KrishiX</p>
          </div>
        </Link>
